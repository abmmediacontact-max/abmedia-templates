...
const CATALOG = [
  ...
  },
  {
        ...
        objective: "Generar conversación con una opinión fuerte sobre tu sector.",
        slides: [
          { overlay: "bottom", body: "Suelta una ==opinión polémica== sobre tu sector.\n\nAñade una caja de respuestas: **\"¿Qué opinas de esto?\"**" }
              ]
  },
  {
        id: "p-vistaincreible", category: "personal", title: "Vista increíble",
        objective: "Mostrar un momento de disfrute que refleje tu estilo de vida.",
        slides: [
          { overlay: "bottom", body: "Añade una foto de una vista increíble de un viaje reciente.\n\n==Qué locura despertarme con estas vistas==\n\nY pensar que todo esto empezó cuando, con 18 años, __perdía dinero en negocios random__ 😅" }
              ]
  },
  {
        id: "p-ultimahora", category: "personal", title: "Última hora",
        objective: "Comentar una novedad del sector y generar debate con una encuesta.",
        slides: [
          { overlay: "bottom", body: "Comparte una noticia o tendencia reciente de tu sector.\n\n**Cuenta qué está pasando…**" },
          { overlay: "bottom", body: "Misma imagen que antes.\n\n==Lanza una pregunta== sobre la que tengas una opinión clara.\n\n**Encuesta:** Opción 1 / Opción 2" }
              ]
  },
  {
        id: "p-mentores", category: "personal", title: "Por qué importan los mentores",
        objective: "Compartir una lección aprendida de un mentor de forma cercana.",
        slides: [
          { overlay: "bottom", body: "Haz una captura de una conversación con uno de tus mentores.\n\nExplica:\n\nEstaba haciendo lo que creía que era correcto…\n\nY hacer \"lo correcto\" __me estaba alejando de [resultado]__\n\nAhora estoy ==mejor que nunca==\n\nEspero que esto le sirva a alguien" }
              ]
  },
...

  {
        ...
        objective: "Usar un meme relatable para conectar y guiar hacia una CTA.",
        slides: [
          { overlay: "full", body: "Añade un ==meme== que refleje una lucha con la que tu audiencia se sienta identificada." },
          { overlay: "bottom", body: "**Explica el meme...**\n\n(desarrolla la idea con tus propias palabras)" },
  ...
  },
  {
        ...
        objective: "Regalar un recurso mostrando una captura de carpeta como gancho visual.",
        slides: [
          { overlay: "bottom", body: "Captura de pantalla de una carpeta de Mac titulada [nombre que indique valor]\n\nEn esta carpeta está ==[el lead magnet o recurso que vas a regalar]== y te lo voy a dar __gratis__\n\nSolo **responde a esta story** y te lo mando." }
              ]
  },
  {
        id: "pu-reciencreado", category: "puente", title: "Recién creado",
        objective: "Anunciar un recurso gratuito actualizado y captar respuestas por DM.",
        slides: [
          { overlay: "bottom", body: "Foto tuya señalando una captura de tu lead magnet\n\nAcabo de crear este ==[recurso gratuito] actualizado para 2027==\n\n• Elemento 1\n• Elemento 2\n• Elemento 3\n\n**Desliza hacia arriba con \"palabra\"** y te mando el [recurso]" }
              ]
  },
  {
        id: "pu-essencillo", category: "puente", title: "Así de simple",
        objective: "Mostrar un resultado y explicar lo fácil que es conseguirlo.",
        slides: [
          { overlay: "bottom", body: "Foto tuya señalando hacia arriba + captura de un resultado propio o de un cliente\n\nEsta es la forma más fácil de ==[conseguir el resultado deseado]== solo con __[una acción sencilla]__\n\nEs así de simple\n\n**[enlace al recurso o tutorial]**" }
              ]
  },
  {
        id: "pu-procesoactual", category: "puente", title: "¿Proceso actual?",
        objective: "Validar interés con una encuesta y entregar un recurso gratuito relacionado.",
        slides: [
          { overlay: "bottom", body: "Foto que dé contexto al tema\n\n¿==[Usas tal elemento]== para [proceso]?\n\nEj: ¿Estás tomando creatina ahora mismo?\n\n**Encuesta:** Sí / No" },
          { overlay: "bottom", body: "La verdad es que nuestros clientes con __mejores resultados__ usan [proceso] para [conseguir resultado]\n\nEsto es clave para [avatar], sobre todo cuando [das el siguiente paso]\n\n(Muestra resultados de clientes que usaron este proceso)" },
          { overlay: "bottom", body: "Imagen del recurso gratuito (tipo miniatura de YouTube)\n\nHe creado ==[recurso]== donde [explico el tema del lead magnet o vídeo + beneficios]\n\n**Responde \"palabra\"** para acceder" }
              ]
  },
    ...
    /* ============================= FLEX ============================= */
  {
        ...
        objective: "Mostrar prueba social en formato POV con testimonios de clientes.",
        slides: [
          { overlay: "full", body: "POV: Te uniste a ==[tu oferta]== 👇\n\n(Añade captura del testimonio + foto tuya señalando hacia arriba)" },
          { overlay: "bottom", body: "**Repite este formato 2-3 veces más** con distintos testimonios de clientes." }
              ]
  },
  {
        id: "f-capturaresultados", category: "flex", title: "Captura de resultados",
        objective: "Mostrar resultados cuantificables sin venderlos directamente.",
        slides: [
          { overlay: "full", body: "Haz una captura de algún tipo de ==seguimiento de resultados== que tengas\n\nEj: ingresos/ventas, visualizaciones, peso perdido, crecimiento de tu portfolio, etc." }
              ]
  },
  {
        ...
        slides: [
          { overlay: "bottom", body: "Enumera las tareas que tienes planeadas para hoy.\n\n**Resalta 1-2** que dejen claro que tu vida/negocio va bien." }
              ]
  },
  {
        id: "f-dopaminadiaria", category: "flex", title: "Dopamina diaria",
        objective: "Mostrar cercanía con tus clientes a través de sus victorias.",
        slides: [
          { overlay: "bottom", body: "Foto tuya (cara visible) + captura de una victoria de un cliente\n\n==Mi dosis diaria de dopamina== es escuchar victorias de clientes" }
              ]
  },
  {
        id: "f-mejorar", category: "flex", title: "Mejorar",
        objective: "Mostrar tu progreso personal o profesional de forma visual.",
        slides: [
          { overlay: "full", body: "Foto de algo que refleje los resultados que has conseguido\n\nEj: vistas desde tu balcón, tu portfolio, una cena cara, tu físico\n\n==[Mejorar]==\n\nEj: hazte más rico, ponte más fuerte, etc." }
              ]
  },
    ...
    /* ============================= VALOR ============================= */
  {
        ...
        slides: [
          { overlay: "bottom", body: "¿Cuál es una pequeña acción que sí tiene un beneficio real, pero que tu cliente ideal ==sobrevalora== o a la que le da demasiadas vueltas?\n\nExplica brevemente de qué se trata y por qué __importa mucho menos__ comparado con lo realmente importante" }
              ]
  },
  {
        ...
        slides: [
          { overlay: "bottom", body: "Muchas veces el ==orden en el que haces las cosas== importa tanto como las cosas en sí.\n\nComparte un ejemplo de algo en lo que se centran los principiantes de tu nicho que __no es importante hasta que están más avanzados__" }
              ]
  },
  {
        ...
        slides: [
          { overlay: "bottom", body: "Comparte una ==app o web útil== que uses habitualmente y que la mayoría de la gente no conoce" }
              ]
  },
  {
        ...
        slides: [
          { overlay: "bottom", body: "Comparte una pequeña táctica que beneficia a tu nicho pero __tarda en dar resultados__" }
              ]
  },
  {
        ...
        slides: [
          { overlay: "bottom", body: "Comparte una pequeña táctica o método que ==suena demasiado bueno para ser verdad== pero que realmente funciona y que has usado para conseguir resultados" }
              ]
  }
  ];
