 ...
 *
 * Las secuencias están organizadas en categorías de uso:
 *   personal   — Cercanía / lifestyle
 *   venta      — Vender / oferta / lanzamiento
 *   puente     — Lead magnets / piezas que llevan a CTA
 *   engagement — Preguntas, encuestas, sliders: que la gente toque la story
 *   flex       — Resultados y casos contados sin vender
 *   valor      — Tips y reflexiones aplicables
 */
...
const CATEGORIES = {
            ...
            engagement: {
                              name: "Engagement",
                              icon: '<svg viewBox="0 0 24 24"><path d="M4 5 H20 V15 H9 L5 19 V15 H4 Z"/></svg>',
                              desc: "Cajas de preguntas, encuestas, sliders: lo que invita a tocar la story. Úsala el día antes de vender: cuanta más gente interactúa, a más gente enseña Instagram la siguiente, y la de venta llega más lejos.",
                              color: "#e3b341"
            },
            flex: {
                              name: "Flex",
...
const CATALOG = [
            /* =========================== PERSONAL =========================== */
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Están siendo días de [situación] y hacer [actividad] me ayuda a recargar las pilas." },
...

        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "Mi misión es ayudarte a (*conseguir resultado*)\n\nResponde: ¿Qué te está limitando ahora mismo para conseguir (*resultado deseado*)?" }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "Qué locura despertarme con estas vistas\n\nY pensar que todo esto empezó cuando, con (*X años*), perdía dinero en (*tu primer negocio/actividad*) 😅" }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Hoy (*resultado actual*).\n\nSi yo pude, tú también puedes." }
                                              ]
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Y termina con (*momento 4 de tu día ideal*) 🤍" }
                                              ]
        },
        {
            ...
            /* ============================ VENTA ============================ */
        {
                        ...
                        slides: [
                                ...
                                { overlay: "full", body: "El año pasado, conseguí [logro].\n\nEste año, quiero [nueva meta / objetivo]." },
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "Si [cliente ideal]…\n\nAtento ➡️" },
                                { overlay: "full", body: "Muchos [cliente ideal] están dejando pasar [resultado soñado] por no hacer esto:\n\n\"[el sistema] →\"" },
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "full", body: "En los últimos [X] años, no he hecho más que dominar [método o habilidad] que [consigue resultado].\n\nHay [X] sistemas que me han permitido replicar estos resultados.\n\nLOS [X] SISTEMAS →" },
                                { overlay: "full", body: "1: [Nombre 1ª parte]\n2: [Nombre 2ª parte]\n3: [Nombre 3ª parte]\n4: [Nombre 4ª parte]\n\nCómo conseguir estos Sistemas →" },
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "full", body: "Esto es súper fácil cuando sabes cómo hacerlo\n\n(*resultado del cliente*)\n\n¿Quieres ayuda para (*conseguir un resultado similar*) y dejar de (*cometer el error típico*)?\n\nEscríbeme \"(*PALABRA*)\"" }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "full", body: "Imagina (*conseguir tal resultado*) en (*poco tiempo*)\n\n✅ (*Beneficio 1*)\n✅ (*Beneficio 2*)\n✅ (*Beneficio 3*)\n\n¿Cómo te sentirías?" },
...

        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Llevo (*X tiempo*) ayudando a (*avatar*) a conseguir (*resultado*) con (*tu método*).\n\nResponde \"(*PALABRA*)\" y hablamos." }
                                              ]
        },
        {
            ...
            /* ============================ PUENTE ============================ */
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Y este es mi [sistema / metodología] que [resultado obtenido]." },
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "He creado un [recurso] detallado que explica la estrategia exacta que utilizo." },
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "En esta carpeta está (*el lead magnet o recurso que vas a regalar*) y te lo voy a dar gratis\n\nSolo responde a esta story y te lo mando." }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "Esta es la forma más fácil de (*conseguir el resultado deseado*) solo con (*una acción sencilla*)\n\nEs así de simple\n\n(*enlace al recurso o tutorial*)" }
                                              ]
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "La verdad es que nuestros clientes con mejores resultados usan (*proceso*) para (*conseguir resultado*)\n\nEsto es clave para (*avatar*), sobre todo cuando (*das el siguiente paso*)" },
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Estoy usando la misma estrategia con la que conseguí (*resultado*) hace (*1 año*)" },
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "full", body: "(*Número*) tips prácticos de alguien que (*lleva X tiempo/ha conseguido Y en tu sector*):\n\n1. (*Tip 1*)\n2. (*Tip 2*)\n3. (*Tip 3*)" }
                                              ]
        },
        {
...

        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Así que he preparado (*recurso o respuesta*) con todo lo que necesitas saber.\n\nResponde \"(*PALABRA*)\" y te lo mando." }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "Esto me ahorra (*X horas / tiempo*) a la semana.\n\nSi quieres (*el mismo ahorro de tiempo*), tengo (*un recurso*) que lo explica paso a paso.\n\nResponde \"(*PALABRA*)\" para acceder." }
                                              ]
        },
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Mi parte favorita: (*detalle del setup*)" }
                                              ]
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "\"¿Y dónde estás ahora?\"\n\n(*Su respuesta*)" }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "Con (*tu sistema/proceso*), (*el resultado*) no es cuestión de suerte.\n\nEs inevitable." }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "Muchas veces el orden en el que haces las cosas importa tanto como las cosas en sí.\n\n(*Ejemplo: algo en lo que se centran los principiantes de tu nicho*) no es importante hasta que están más avanzados" }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "Antes pensaba que necesitaba (*un error común*).\n\nPero (*tu sector*) no premia (*el error*) primero. Premia la claridad." },
                                { overlay: "bottom", body: "La gente que gana (*en tu sector*) repite un mensaje claro.\n\nCon el tiempo, (*cómo llega el resultado soñado*)." }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "bottom", body: "(*Decisión o hábito común en tu nicho*) tiene un coste oculto que casi nadie tiene en cuenta: (*el coste real: tiempo, dinero, oportunidad*)" }
                                              ]
        },
        {
        ...
        },
        {
                        ...
                        slides: [
                                ...
                                { overlay: "bottom", body: "(*El rasgo negativo concreto*)\n\nEvítalo y ya vas por delante del resto" }
                                              ]
        },

            /* ========================= ENGAGEMENT ========================= *
             * Stories hechas para que la gente toque: responder, votar,
             * deslizar. Cada interacción le dice a Instagram que esa cuenta
             * interesa, y la story siguiente —la de venta— sale a más gente.
             * El sticker se dibuja con el aspecto del nativo de Instagram
             * para que la plantilla se entienda de un vistazo; al publicar se
             * pone el sticker de verdad encima. */
        {
        ...
        },
        {
                        ...
                        slides: [
                                { overlay: "full", body: "Levanta la mano si alguna vez te ha pasado esto con (*tu tema*):\n\n(*el problema concreto*)", sticker: { tipo: "encuesta", texto: "¿Te ha pasado?", opciones: ["Sí, a mí también", "Nunca"], y: 0.64 } }
                                              ]
        },
        {
